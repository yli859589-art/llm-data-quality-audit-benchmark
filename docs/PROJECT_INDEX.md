...
| `projects/d2l/` | textbook-style DL building blocks | `src/course_project_suite/d2l/` |
| `projects/cs224n/` | NLP and GPT-style modeling | `src/course_project_suite/cs224n/` |
| `projects/cs336/` | language-modeling systems | `src/course_project_suite/cs336/` |
