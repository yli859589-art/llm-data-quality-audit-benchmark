...
- Andrej Karpathy, [`karpathy/char-rnn`](https://github.com/karpathy/char-rnn), Tiny Shakespeare dataset directory: [`data/tinyshakespeare`](https://github.com/karpathy/char-rnn/tree/master/data/tinyshakespeare).
