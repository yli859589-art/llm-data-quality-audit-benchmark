...
def main() -> None:
    ...
    status_lines = [
        ...
        "claim supported improvement unless the status and seed budget allow it.",
        "",
        "3B adds OpenWebText and C4 English real HuggingFace streaming samples. These are "
        "explicitly bounded streaming samples, not complete upstream corpora. Their evidence is reported in "
        "`artifacts/cross_dataset/` and `docs/CROSS_DATASET_AUDIT.md`.",
        "",
